                ...
                itemBuilder: (context, index) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      // Container(height: 250,width: Get.width*6,color: Colors.orange,),
                      Image.asset(item["image"]!, height: 250,width: Get.width*6,),
                      SizedBox(height: 20),
                      CustomText(
                          text: item["title"]!,
                          fontSize: 20.sp,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  ).marginOnly(bottom: 7.hr(context)),
                ],
              ),
            ),
          ],
        ).paddingSymmetric(horizontal: 20.wr(context)));
  }
